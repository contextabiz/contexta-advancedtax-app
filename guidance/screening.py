...
def build_screening_inputs(
    *,
    ...
    return {
        "has_spouse": inferred["has_spouse"],
        "has_dependants": inferred["has_dependants"],
        "paid_rent_or_property_tax": inferred["paid_rent_or_property_tax"],
        "paid_tuition": inferred["paid_tuition"],
        "paid_student_loan_interest": float(raw_inputs.get("student_loan_interest", session_state.get("student_loan_interest", 0.0)) or 0.0) > 0,
        "had_medical_expenses": inferred["had_medical_expenses"],
        "made_donations": inferred["made_donations"],
        "had_moving_expenses": inferred["had_moving_expenses"],
        "had_child_care_expenses": inferred["had_child_care_expenses"],
        "had_work_expenses": inferred["had_work_expenses"],
        "had_foreign_income": inferred["had_foreign_income"],
        "had_investment_income": inferred["had_investment_income"],
        "low_income_self_assessed": False,
        "wants_household_help": False,
        "province": province,
